...
# 진짜 화학 성분명 vs 도메인/주제어(증상·표현) 구분용.
# '백탁이 심해요'는 커머스 리뷰가 더 맞는 답이고, '에칠헥실트리아존 쓰는 선크림'은
# 처방 데이터(formula_full 등)가 더 맞는 답이다. matched_ingredients 에 둘 다
# 섞여 들어오므로, 소스 우선순위 로직에서는 이 목록을 빼고 판단해야 한다.
DOMAIN_TOPIC_TERMS = {
    "선크림", "썬크림", "선스크린", "무기자차", "유기자차", "혼합자차",
    "백탁", "톤업", "제형", "차단지수", "내수성", "워터프루프",
    "기능성화장품", "전성분", "배합순위", "미백기능", "주름개선",
}
